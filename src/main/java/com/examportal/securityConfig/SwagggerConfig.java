...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Exam Portal : Application",
				"This project is developed by Parvaiz Sajad", "1.0", "Terms of Service",
				new Contact("Parvaiz Sajad", "https://github.com/parvaizsajad", "parvaizsajjad@gmail.com"),
